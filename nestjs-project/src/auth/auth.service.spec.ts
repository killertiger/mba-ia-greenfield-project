...
/**
 * Mocks are declared as plain objects of `jest.Mock` instead of
 * `jest.Mocked<Class>`: asserting on `mock.method` with the class type trips
 * `unbound-method`, and the typed parameters force `as any` on every fixture.
 */
...
describe('AuthService — register', () => {
  ...
  let verificationTokenRepository: TokenRepositoryMock;
  ...
  beforeEach(async () => {
    ...
    verificationTokenRepository = module.get<TokenRepositoryMock>(
...
describe('AuthService — login', () => {
  let authService: AuthService;
  let usersService: UsersServiceMock;
  let refreshTokenRepository: TokenRepositoryMock;
  ...
  beforeEach(async () => {
    ...
    authService = module.get(AuthService);
    usersService = module.get<UsersServiceMock>(UsersService);
    refreshTokenRepository = module.get<TokenRepositoryMock>(
